-- ============================================================================
-- MIGRATION 004: ADD SHIPMENT SCHEMA (Layer 3 - Decision Support) - CLEAN VERSION
-- ============================================================================
...
DROP TRIGGER IF EXISTS trigger_shipment_containers_updated_at ON shipment_containers;
DROP TRIGGER IF EXISTS trigger_shipment_financials_updated_at ON shipment_financials;
