...
const WORKFLOW_STATES: WorkflowStateInfo[] = [
  // Pre-Departure
  { state_code: 'booking_confirmation_received', state_name: 'Booking Received', state_order: 10, phase: 'pre_departure', is_completed: false, is_current: false, is_skipped: false, required_doc_types: ['booking_confirmation'] },
  { state_code: 'booking_confirmation_shared', state_name: 'Booking Shared', state_order: 20, phase: 'pre_departure', is_completed: false, is_current: false, is_skipped: false, required_doc_types: [] },
  { state_code: 'commercial_invoice_received', state_name: 'Invoice Received', state_order: 30, phase: 'pre_departure', is_completed: false, is_current: false, is_skipped: false, required_doc_types: ['commercial_invoice', 'invoice'] },
  ...
  { state_code: 'si_draft_received', state_name: 'SI Draft Received', state_order: 50, phase: 'pre_departure', is_completed: false, is_current: false, is_skipped: false, required_doc_types: ['si_draft', 'shipping_instruction'] },
  ...
  { state_code: 'si_confirmed', state_name: 'SI Confirmed', state_order: 65, phase: 'pre_departure', is_completed: false, is_current: false, is_skipped: false, required_doc_types: ['si_confirmation'] },
  // HBL Draft is pre-departure (before vessel sails)
  { state_code: 'hbl_draft_sent', state_name: 'HBL Draft Sent', state_order: 70, phase: 'pre_departure', is_completed: false, is_current: false, is_skipped: false, required_doc_types: ['house_bl', 'bill_of_lading'] },
  // In Transit
  { state_code: 'invoice_sent', state_name: 'Invoice Sent', state_order: 80, phase: 'in_transit', is_completed: false, is_current: false, is_skipped: false, required_doc_types: [] },
  { state_code: 'hbl_released', state_name: 'HBL Released', state_order: 90, phase: 'in_transit', is_completed: false, is_current: false, is_skipped: false, required_doc_types: [] },
  // Arrival
  ...
  { state_code: 'arrival_notice_shared', state_name: 'AN Shared', state_order: 110, phase: 'arrival', is_completed: false, is_current: false, is_skipped: false, required_doc_types: [] },
  { state_code: 'entry_summary_approved', state_name: 'Entry Approved', state_order: 120, phase: 'arrival', is_completed: false, is_current: false, is_skipped: false, required_doc_types: ['entry_summary'] },
