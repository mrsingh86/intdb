/**
 * Trace Pipeline Flow - Shows how data flows through the system (second example)
 */
...
async function traceAnotherEmail() {
  console.log('════════════════════════════════════════════════════════════════════');
  console.log('TRACING ANOTHER EMAIL THROUGH COMPLETE PIPELINE');
  console.log('════════════════════════════════════════════════════════════════════\n');

  // Find a DIFFERENT shipment with complete data (skip the first few)
...
traceAnotherEmail().catch(console.error);
